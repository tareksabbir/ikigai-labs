      ...
      <div className="max-w-7xl mx-auto px-6 w-[92%] relative">
                ...
                <nav className="flex flex-col gap-4">
                  {group.links.map((link) => (
                    <Link
                      key={link.label}
                      href={link.href}
                      className="text-white/40 text-sm hover:text-white transition-colors duration-200 flex items-center group/link w-fit"
                    >
                      {link.label}
                      <ArrowUpRight 
                        size={12} 
        ...
        <div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 text-[13px]">
          ...
          <div className="flex items-center gap-8">
            <Link href="#" className="text-white/20 hover:text-white/40 transition-colors">
              Privacy Policy
            </Link>
            <Link href="#" className="text-white/20 hover:text-white/40 transition-colors">
              Terms of Service
            ...
            <button
              ...
              className="group flex items-center gap-2 text-white/20 hover:text-white/40 transition-colors pl-8 border-l border-white/5"
            >
              Back to top
